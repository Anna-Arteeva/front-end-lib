window.cfields = {"3": "company", "5": "country_territory", "4": "message"};
...
(function ()
{
    ...
    _load_script(
        "//d3rxaij56vjege.cloudfront.net/form-serialize/0.3/serialize.min.js", function ()
        {
    ...
    var form_submit = function (e)
    {
        ...
        if (validate_form())
        {
            ...
            _load_script('https://signkick.activehosted.com/proc.php?' + serialized + '&jsonp=true');
        }
